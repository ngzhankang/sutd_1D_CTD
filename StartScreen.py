class StartScreen:
    ...
    def setup_ui(self):
        ...
        self.start_label = self.tk.Label(self.root, text="Welcome to", font=("Poppins Bold", 18) ,bg='#1B1B1B', fg='White')
        self.start_label.place(relx=0.5, rely=0.26, anchor="center")  # Center the title label
    
        self.welcome_label = self.tk.Label(self.root, text="'Study Up Till Death'", font=("Old School Adventures", 33),bg='#1B1B1B', fg='#E6A900')
